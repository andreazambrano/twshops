...
function t_lazyload_getResizeUrl(e, t, i, o, n, l, a, r) {
    if ("undefined" == i || null == i)
        return i;
    if (0 < i.indexOf(".svg") || 0 < i.indexOf(".gif") || 0 < i.indexOf(".ico") || -1 === i.indexOf("static.tildacdn.com") || 0 < i.indexOf("-/empty/") || 0 < i.indexOf("-/resizeb/"))
        return i;
    if (-1 < i.indexOf("/-/"))
        return i;
    if (!(0 < o && 0 < n))
    ...
    0 < n && (n = parseInt(2 * n))),
    1e3 < o || 1800 < n)
        return s = t_lazyload_getWebPUrl(i);
    if ("IMG" == e) {
        ...
        (d = i.split("/")).splice(i.split("/").length - 1, 0, "-/" + t + "/" + o + "x" + n + "/" + l + "/" + a + "/" + ("y" == window.lazy_webp ? "-/format/webp" : ""));
...
function t_lazyload_round(e, t, i, o) {
    if ("cover" == e && 0 < t && 0 < i) {
        ...
        l = t / i;
        0 < t && (t = Math.ceil(t * o) * o),
        0 < i && 0 < l && (i = Math.ceil(t / l))
    }
    return [t, i]
}
...
function t_lazyload_getWebPUrl(e) {
    if ("undefined" == e || null == e)
        return e;
    if (0 < e.indexOf(".svg") || 0 < e.indexOf(".gif") || 0 < e.indexOf(".ico") || -1 === e.indexOf("static.tildacdn.com") || 0 < e.indexOf("-/empty/") || 0 < e.indexOf("-/resizeb/"))
        return e;
    if (-1 < e.indexOf("/-/"))
        return e;
    if (-1 < e.indexOf("lib"))
    ...
    t.join("/").replace("/static.tilda", "/thumb.tilda")
}
...
!function(e, t) {
    ...
    function _(e, t, i, o) {
        ...
        if (null != n) {
            ...
            var s = ""
              ...
              , u = ""
              , _ = "";
            "IMG" === t.tagName ? u = "resize" : (s = t.style.backgroundPositionX,
            d = t.style.backgroundPositionY,
            u = "cover",
            "contain" == (c = r.css("background-size")) && (u = "contain"));
            var h = 1
              , f = !0;
            if (void 0 !== r.attr("data-lazy-rule") && -1 < (_ = r.attr("data-lazy-rule")).indexOf("round:") && (h = 1 * _.split(":")[1]),
            1 < h) {
                var g = t_lazyload_round(u, l, a, h);
                l = g[0],
                a = g[1]
            }
            "cover" == u && 0 < l && 0 < a && l <= 1e3 && (l === 10 * Math.ceil(l / 10) && a === 10 * Math.ceil(a / 10) || -1 < ["200x151", "640x712", "320x356", "670x744", "335x372", "300x225", "500x375", "400x301", "748x832", "374x416", "670x502", "335x251", "360x234", "560x622", "280x311", "640x416"].indexOf(l + "x" + a) || (f = !1)),
            !0 === f && (n = 1e3 < l || 1e3 < a || 0 == l || "IMG" != t.tagName && 0 == a || "skip" == _ ? t_lazyload_getWebPUrl(n) : t_lazyload_getResizeUrl(t.tagName, u, n, l, a, s, d, c)),
    ...
    e.prototype._loopThroughElements = function() {
        var e, t, i = this._settings, o = this._elements, n = o ? o.length : 0, l = [];
        for (e = 0; e < n; e++)
            t = o[e],
            i.skip_invisible && null === t.offsetParent || s(t, i.container, i.threshold) && (i.show_while_loading ? this._showOnAppear(t) : this._showOnLoad(t),
            l.push(e),
            t.wasProcessed = !0);
        for (; 0 < l.length; )
            o.splice(l.pop(), 1),
            i.callback_processed && i.callback_processed(o.length);
        0 === n && this._stopScrollHandler()
    }
    ,
    e.prototype._purgeElements = function() {
        var e, t = this._elements, i = t.length, o = [];
        for (e = 0; e < i; e++)
            t[e].wasProcessed && o.push(e);
        for (; 0 < o.length; )
            t.splice(o.pop(), 1)
    }
    ,
...
$(document).ready(function() {
    ...
    $(".t492,.t552,.t251,.t603,.t660,.t661,.t662,.t680,.t827,.t909,.t218,.t740,.t132,.t694,.t762,.t786,.t546").find(".t-bgimg").attr("data-lazy-rule", "round:100"),
    setTimeout(function() {
...
window.t_lazyload_updateResize_elem = function(e) {
    if (console.log("update resize elem"),
    0 != e.length) {
        var t = e.get(0)
          , i = t.tagName;
        if ("IMG" == i)
            ...
            if ("contain" == e.css("background-size"))
                n = "-/contain/";
            else
                n = "-/cover/"
        }
